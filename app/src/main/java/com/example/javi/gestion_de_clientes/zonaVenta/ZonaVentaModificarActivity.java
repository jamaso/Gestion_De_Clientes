...
public class ZonaVentaModificarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etNumZona = (EditText) findViewById(R.id.editTextNumZona);
        etLocalidad = (EditText) findViewById(R.id.editTextLoclidad);

         zonaId =this.getIntent().getExtras().getInt(Contrato.ZonaVenta._ID);
        ZonaVenta zonaVenta = ZonaventasProveedor.readReccords(getContentResolver(),zonaId);

        etNumZona.setText(zonaVenta.getNumZona());
        etLocalidad.setText(zonaVenta.getLocalidad());
    ...
    void attempGuardar() {
        ...
        ZonaVenta zonaVenta = new ZonaVenta( zonaId, numZona,localidad);
        ZonaventasProveedor.update( getContentResolver(), zonaVenta);
        finish();
